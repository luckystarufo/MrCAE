...
model_path = '/usr/workspace/wsb/liu73/model/fluid/'
result_path = '/usr/workspace/wsb/liu73/result/fluid/'
...
n_filters = 5
tol = 0.005
net.train_net_one_stage(mode=mode, n_filters=n_filters, dataset=dataset, max_epoch=3000, batch_size=350, tol=tol, load_model=load_model, activation=torch.nn.Sequential(), w=0.5, model_path=model_path, result_path=result_path, std=0.01)
'''
